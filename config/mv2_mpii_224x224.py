...
workflow = [('train', 1)]
checkpoint_config = dict(interval=5)  #10
...
model = dict(
    type='TopDown',
    pretrained=None,#'models/pytorch/imagenet/mobilenet_v2_batch256_20200708-3b2dc3af.pth',
    backbone=dict(type='MobileNetV2', widen_factor=1., out_indices=(7, )),
    keypoint_head=dict(
        type='TopDownupsample',#TopDownSimpleHead/TopDownpixelshuffle
        in_channels=1280,
...
data_root = '/media/hkuit104/24d4ed16-ee67-4121-8359-66a09cede5e7/mmpose/data/mpii'#'/home/user/Documents/mmpose/data/mpii'
